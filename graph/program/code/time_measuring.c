...
size_t iterations_to_find_min = 300;
...
measurement_info measure_function_multiple_times(
...
)
{
	...
	for (size_t i = 1; i <= different_sizes; i++)
	{
		...
		measurement_info measurements = measure_function_multiple_times(function_prep, function, function_clean_up, modify_measurements, n);
